...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<actionview>.freeze, ["= 6.0.4.7"])
    s.add_dependency(%q<activemodel>.freeze, ["= 6.0.4.7"])
    s.add_dependency(%q<activerecord>.freeze, ["= 6.0.4.7"])
    s.add_dependency(%q<actionmailer>.freeze, ["= 6.0.4.7"])
    s.add_dependency(%q<activejob>.freeze, ["= 6.0.4.7"])
    s.add_dependency(%q<actioncable>.freeze, ["= 6.0.4.7"])
    s.add_dependency(%q<activestorage>.freeze, ["= 6.0.4.7"])
    s.add_dependency(%q<actionmailbox>.freeze, ["= 6.0.4.7"])
    s.add_dependency(%q<actiontext>.freeze, ["= 6.0.4.7"])
    s.add_dependency(%q<railties>.freeze, ["= 6.0.4.7"])
